  ...
  return {
    ...
    find: function find(selector) {
      ...
      for (var i = 0; i < elements.length; i++) {
        var elements2 = Array.from(elements[i].querySelectorAll(selector)); // const elements2 = elements[i].querySelectorAll(selector)
    ...
    parent: function parent(elements) {
      var array = [];
